...
namespace hist_mmorpg
{
    ...
    public enum Actions
    {
        ...
        AcceptRejectAlliance, OfferAllianceAgainst, AcceptRejectAllianceAgainst, OfferPeace, ChangeAttackAutoSupport, ChangeDefenceAutoSupport, RecruitNew, ChangeAutoPillage, PlanAssassination
    }
    /// <summary>
